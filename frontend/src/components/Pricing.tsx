...
const tiers = [
  {
    ...
    features: ['Full functional lab panel', 'Weekly acupuncture', 'Somatic healing sessions', 'Personalized supplement protocol', 'Ongoing check-ins'],
    featured: false,
  },
  {
    name: 'Both of You',
    ...
    features: ['Individual lab work for both', 'Joint and individual sessions', 'Partner nutrition protocol', 'Stress and lifestyle optimization', 'Full 90-day support'],
    featured: true,
  },
  {
    ...
    features: ['Preconception or postpartum only', 'Integration sessions', 'Somatic support included', 'No prior experience required'],
    featured: false,
  },
]
    ...
    <section id="pricing" data-section="pricing" className={`section ${styles.pricing}`}>
      <div className="container">
        <div className={styles.header}>
          <p data-reveal className="section-label">The Program</p>
          <h2 data-reveal className={styles.heading}>
            This is not just<br />her journey.
          </h2>
        </div>

        <div className={styles.cards}>
          {tiers.map((t) => (
            <div key={t.name} className={`${styles.card} ${t.featured ? styles.featured : ''}`} data-stagger>
              ...
              <a href="#contact" className={`btn ${t.featured ? 'btn-primary' : 'btn-ghost'} ${styles.cardCta}`}>
