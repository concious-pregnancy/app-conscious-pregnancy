    ...
    <section data-section="credentials" className={`section ${styles.credentials}`}>
      <div className="container">
        <p data-reveal className={styles.heading}>
          Dr. Ashley Alden brings Eastern and Western medicine together in a single practice:
          functional labs, acupuncture, somatic healing, and integration work, all oriented toward
          the same goal.
        </p>
