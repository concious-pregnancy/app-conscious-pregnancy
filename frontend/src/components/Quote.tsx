      ...
      <div className="container">
        <div className={styles.inner}>
          ...
          <blockquote data-reveal className={styles.text}>
            &ldquo;Every cell in your future baby&rsquo;s body will be built from the nutrients you
            have available at conception. The 90-day preconception window is the most important
            nutritional window of your child&rsquo;s life.&rdquo;
          </blockquote>
          <cite data-reveal className={styles.author}>
